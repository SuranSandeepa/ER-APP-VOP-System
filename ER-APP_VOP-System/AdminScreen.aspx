...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container alert alert-primary w3-padding-top w3-padding-bottom w3-margin-top w3-margin-bottom" style="text-align: center; background-color:#28313B; color:white;">
    ...
    <section>
        <div class="container table-responsive">
            <asp:GridView ID="dgvExcelUpload" CssClass="table table-bordered" runat="server" AutoGenerateColumns="false" EmptyDataText="No Record Found" PageSize="30" HorizontalAlign="Center" BackColor="Silver" BorderColor="#003366" Font-Bold="True" Font-Names="Calibri">
                <Columns>
